...
# Build the autoencoder model of u2d_org
...
# Data loading
if envir == 'indoor':
    mat = sio.loadmat('data/indoor53/Data100_Htrainin_down_FDD.mat')
    mat1 = sio.loadmat('data/indoor53/Data100_Htrainin_up_FDD.mat')
    x_train = mat['HD_train']
    x_train_up = mat1['HU_train']
    mat = sio.loadmat('data/indoor53/Data100_Hvalin_down_FDD.mat')
    mat1 = sio.loadmat('data/indoor53/Data100_Hvalin_up_FDD.mat')
    x_val = mat['HD_val']
    ...
    mat = sio.loadmat('data/urban3/Data100_Htrainin_down_FDD.mat')
    mat1 = sio.loadmat('data/urban3/Data100_Htrainin_up_FDD.mat')
    x_train = mat['HD_train']
    x_train_up = mat1['HU_train']
    mat = sio.loadmat('data/urban3/Data100_Hvalin_down_FDD.mat')
    mat1 = sio.loadmat('data/urban3/Data100_Hvalin_up_FDD.mat')
    x_val = mat['HD_val']
    x_val_up = mat1['HU_val']
...
file = 'u2d_org_' + (envir) + time.strftime('_%m_%d')
path = 'result_u2d/TensorBoard_%s/1' % file

# Prepare model model saving directory.
save_dir = os.path.join(os.getcwd(), 'result/saved_models_u2d_org')
