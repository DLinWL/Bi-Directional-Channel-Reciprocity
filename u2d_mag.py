...
from keras.layers import Input, Dense, BatchNormalization, Reshape, Conv2D, add, LeakyReLU, concatenate, Lambda, Dropout
...
# Build the autoencoder model of u2d_mag
...
file = 'u2d_mag_' + (envir) + '_dim' + str(encoded_dim) + time.strftime('_%m_%d')
path = 'result_u2d/TensorBoard_%s/1' % file

# Prepare model model saving directory.
save_dir = os.path.join(os.getcwd(), 'result_u2d/saved_models_u2d_mag')
